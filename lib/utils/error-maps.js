...
var error_map = [
    ...
    {
        id: "HTTP_STATUS",
        description: "Http status code invalid",
        regex: /HTTPSTATUSCODE/
    },
    {
        id: "SSL_NAME_MISMATCH",
        description: "The SSL Certificate does not match the domain",
        regex: /Hostname\/IP doesn't match certificate's altnames/
    }
];
